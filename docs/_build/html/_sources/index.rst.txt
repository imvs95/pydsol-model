...
**pydsol-model** is an additional layer on top of pydsol-core, a Python distribution discrete event simulation library based on PhD thesis of and the exact simulation formulation of `Jacobs (2005) <http://resolver.tudelft.nl/uuid:4c5586e2-85a8-4e02-9b50-7c6311ed1278>`_ and `Zeigler et al. (2000) <https://dl.acm.org/doi/10.5555/580780>`_.
